...
//	   TASTIMONIAL Upload path 
	   public static final String CONST_TASTIMONIAL_IMAGE_UPLOAD_PATH = "public/upload/tastimonial/";
...
# Enterprise Upload path 
upload_enterprise_path = public/upload/enterprise/
*/
